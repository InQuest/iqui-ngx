...
libVersion=$( cat ../dist/iqui-ngx-elements/package.json | jq -r ".version");
...
libName=$( cat ../dist/iqui-ngx-elements/package.json | jq -r ".name");
...
libDescription=$( cat ../dist/iqui-ngx-elements/package.json | jq -r ".description");
