...
libVersion=$( cat ../dist/ng-intellegens-grid/package.json | jq -r ".version");
...
libName=$( cat ../dist/ng-intellegens-grid/package.json | jq -r ".name");
...
libDescription=$( cat ../dist/ng-intellegens-grid/package.json | jq -r ".description");
